...
//
//	mockgen -source=./pkg/api/email_client_service/email-client-service_grpc.pb.go EmailClientServiceApiClient
//
...
func (mr *MockEmailClientServiceApiClientMockRecorder) SendEmail(ctx, in any, opts ...any) *gomock.Call {
...
func (mr *MockEmailClientServiceApiClientMockRecorder) Status(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
...
// SendEmail indicates an expected call of SendEmail.
func (mr *MockEmailClientServiceApiServerMockRecorder) SendEmail(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Status indicates an expected call of Status.
func (mr *MockEmailClientServiceApiServerMockRecorder) Status(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
